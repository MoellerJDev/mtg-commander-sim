...
- Default branch: `main`
- Active branch: `feat/rules-combat-composition-targets`
...
| [#45](https://github.com/MoellerJDev/mtg-commander-sim/pull/45) | `feat/rules-combat-composition-targets` | `main` | `open` |
...
- Oracle coverage: material_residuals=69890, status_counts={'exact': 2959, 'partial': 16039, 'unresolved': 19486}, total=38484
- Commander-legal Oracle coverage: material_residuals=61213, status_counts={'exact': 338, 'partial': 14613, 'unresolved': 16672}, total=31623
...
|---|---|---|
| Integrated deterministic foundation | `complete` | Integration PRs #1-17 and #24-44 are on main; focused combat-composition PR #45 is active. PR #24 incorporated every ancestry-proven CR 400-408 head; GitHub auto-recorded PR #17 as merged and PRs #18-23 were closed as superseded only after their exact heads became reachable from main. |
...
- Tests discovered: 4097
- Python matrix: Python 3.11 and 3.12 on Ubuntu and Windows
- Baseline CI: [30695738424](https://github.com/MoellerJDev/mtg-commander-sim/actions/runs/30695738424) — `pass`
- Compile: `pass`
...
After PR #45, extend the shared finite combat declaration solver to shared-subtype quantifiers, named/planeswalker attack targets, history-, monarch-, poison-, non-goad requirement-, other effect-granted-, optional-cost-, and multi-block grammar; then route declaration triggers through the same boundary while keeping the universal CR 120.4 damage transformation pipeline as the next deeper dependency.
