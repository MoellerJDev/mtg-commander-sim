...
Keep dependency-staged CR 400 PR #17 in draft while GitHub cannot allocate runners, and begin CR 401 Library without promoting incomplete hidden-zone semantics.
