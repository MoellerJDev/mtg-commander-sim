...
- Oracle coverage: material_residuals=69890, status_counts={'exact': 2959, 'partial': 15981, 'unresolved': 19544}, total=38484
- Commander-legal Oracle coverage: material_residuals=61213, status_counts={'exact': 338, 'partial': 14557, 'unresolved': 16728}, total=31623
...
|---|---|---|
| Integrated deterministic foundation | `complete` | Integration PRs #1-17 and #24-42 are on main. PR #24 incorporated every ancestry-proven CR 400-408 head; GitHub auto-recorded PR #17 as merged and PRs #18-23 were closed as superseded only after their exact heads became reachable from main. |
