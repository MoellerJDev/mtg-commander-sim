...
- Default branch: `main`
- Active branch: `feat/rules-combat-quantifiers-planeswalkers`
...
- Rules cases: blocked=362, definition_only=81, passing=120, total=3300, unreviewed=2737
- Mechanics: status_counts={'partial': 57, 'unclassified': 368}, total=425, trusted=0
- Oracle coverage: material_residuals=69890, status_counts={'exact': 2959, 'partial': 16042, 'unresolved': 19483}, total=38484
- Commander-legal Oracle coverage: material_residuals=61213, status_counts={'exact': 338, 'partial': 14616, 'unresolved': 16669}, total=31623
...
|---|---|---|
| Integrated deterministic foundation | `complete` | Integration PRs #1-17 and #24-45 are on main; the focused planeswalker-combat and declaration-quantifier slice is active. PR #24 incorporated every ancestry-proven CR 400-408 head; GitHub auto-recorded PR #17 as merged and PRs #18-23 were closed as superseded only after their exact heads became reachable from main. |
...
- Tests discovered: 4106
- Python matrix: Python 3.11 and 3.12 on Ubuntu and Windows
- Baseline CI: [30697071401](https://github.com/MoellerJDev/mtg-commander-sim/actions/runs/30697071401) — `pass`
- Compile: `pass`
...
After the planeswalker-combat and declaration-quantifier slice, extend the shared finite combat declaration solver to history-, monarch-, poison-, non-goad requirement-, other effect-granted-, optional-cost-, and multi-block grammar; then route declaration triggers through the same boundary while keeping the universal CR 120.4 damage transformation pipeline as the next deeper dependency.
