...
- Production scope: 261 files, 110,288 physical lines, 101,145 logical lines
...
- Python discovered: 4,967
- Conventional Python cases: 1,667
...
- Capability mutation declarations: 56
