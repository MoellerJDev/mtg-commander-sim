...
- Production scope: 262 files, 110,373 physical lines, 101,214 logical lines

## Central engine debt

- `engine.py`: 13,377 physical / 12,640 logical lines
...
|---|---:|---:|---:|
| `engine_logical_lines` | 13,017 | 12,640 | -377 |
...
|---|---:|---:|---:|
| `mtg_commander_sim/engine.py` | python | 13,377 | 12,640 |
...
| `CommanderEngine._stabilize` | `mtg_commander_sim/engine.py:12618` | 342 | 354 |
...
- Python discovered: 4,977
- Conventional Python cases: 1,677
...
- Capability mutation declarations: 57
