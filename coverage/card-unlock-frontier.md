...
verified: "5d7cc59a38b645dfbb18eff020a9ebecadc952b80f8ceb794b4d40ce4184b894"
...
- Oracle states: `{"exact":2098,"partial":13209,"unresolved":16316}`
- CardProgram states: `{"residual":29525,"trusted":2098}`
- Hard construction failures: 0
- Frontier fingerprint: `5d7cc59a38b645dfbb18eff020a9ebecadc952b80f8ceb794b4d40ce4184b894`
...
| `effect_clause:deal-damage` | 1,048 | 1,016 | 140 | 290 | missing_lowering | high |
| `mechanic_dependency:cr-509-declare-blockers-step` | 421 | 416 | 136 | 385 | partial | high |
| `effect_clause:return` | 743 | 716 | 113 | 254 | missing_lowering | high |
| `mechanic_dependency:cr-111-tokens` | 311 | 306 | 106 | 311 | partial | high |
| `effect_clause:destroy-target` | 590 | 557 | 96 | 254 | missing_lowering | high |
| `effect_clause:exile` | 1,059 | 1,010 | 92 | 462 | missing_lowering | high |
...
| `effect_clause:destroy-mass` | 201 | 190 | 46 | 88 | missing_lowering | high |
...
| `continuous_layer:continuous-effect-layers-and-dependencies, mechanic_dependency:cr-611-continuous-effects, mechanic_dependency:cr-614-replacement-effects` | 3,722 | 10,471 | 10,471 |
| `continuous_layer:continuous-effect-layers-and-dependencies, mechanic_dependency:cr-614-replacement-effects, mechanic_dependency:cr-509-declare-blockers-step` | 3,694 | 10,510 | 10,510 |
...
| `continuous_layer:continuous-effect-layers-and-dependencies, mechanic_dependency:cr-611-continuous-effects, effect_clause:deal-damage` | 3,678 | 10,230 | 10,230 |
...
| `continuous_layer:continuous-effect-layers-and-dependencies, effect_clause:deal-damage, mechanic_dependency:cr-509-declare-blockers-step` | 3,650 | 10,269 | 10,269 |
| `continuous_layer:continuous-effect-layers-and-dependencies, mechanic_dependency:cr-614-replacement-effects, mechanic_dependency:cr-111-tokens` | 3,648 | 10,436 | 10,436 |
| `continuous_layer:continuous-effect-layers-and-dependencies, mechanic_dependency:cr-614-replacement-effects, effect_clause:deal-damage` | 3,644 | 10,415 | 10,415 |
| `continuous_layer:continuous-effect-layers-and-dependencies, mechanic_dependency:cr-611-continuous-effects, effect_clause:destroy-target` | 3,634 | 10,194 | 10,194 |
| `continuous_layer:continuous-effect-layers-and-dependencies, mechanic_dependency:cr-611-continuous-effects, effect_clause:exile` | 3,632 | 10,402 | 10,402 |
| `continuous_layer:continuous-effect-layers-and-dependencies, mechanic_dependency:cr-611-continuous-effects, activated_effect:deal-damage` | 3,632 | 10,120 | 10,172 |
...
| `continuous_layer:continuous-effect-layers-and-dependencies, mechanic_dependency:cr-614-replacement-effects, effect_clause:return` | 3,619 | 10,379 | 10,379 |
