...
verified: "d6e6f221cf6773162c09234b85df3948c2734e902b30fcdd2d3b89101dc7ca00"
...
- Oracle states: `{"exact":2187,"partial":13251,"unresolved":16185}`
- CardProgram states: `{"residual":29436,"trusted":2187}`
- Hard construction failures: 0
- Frontier fingerprint: `d6e6f221cf6773162c09234b85df3948c2734e902b30fcdd2d3b89101dc7ca00`
...
| `mechanic_dependency:cr-111-tokens` | 319 | 314 | 111 | 319 | partial | high |
...
| `mechanic_dependency:cr-115-targets` | 359 | 341 | 82 | 156 | missing_contract | high |
...
| `continuous_layer:continuous-effect-layers-and-dependencies, mechanic_dependency:cr-611-continuous-effects, mechanic_dependency:cr-111-tokens` | 3,675 | 10,243 | 10,243 |
| `continuous_layer:continuous-effect-layers-and-dependencies, mechanic_dependency:cr-611-continuous-effects, mechanic_dependency:cr-115-targets` | 3,660 | 10,167 | 10,167 |
| `continuous_layer:continuous-effect-layers-and-dependencies, mechanic_dependency:cr-509-declare-blockers-step, mechanic_dependency:cr-111-tokens` | 3,646 | 10,282 | 10,282 |
| `continuous_layer:continuous-effect-layers-and-dependencies, mechanic_dependency:cr-614-replacement-effects, mechanic_dependency:cr-111-tokens` | 3,645 | 10,428 | 10,428 |
...
| `continuous_layer:continuous-effect-layers-and-dependencies, mechanic_dependency:cr-611-continuous-effects, activated_effect:deal-damage` | 3,616 | 10,096 | 10,145 |
...
| `continuous_layer:continuous-effect-layers-and-dependencies, mechanic_dependency:cr-611-continuous-effects, activated_effect:create-token` | 3,600 | 10,120 | 10,193 |
