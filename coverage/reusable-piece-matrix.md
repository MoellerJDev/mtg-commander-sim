...
verified: "7063b60c4446f094a94165e14b83aa0971360909c809d8c2d87a956ad9f8804c"
...
- Applicable piece pairs: 20,753
- Covered piece pairs: 118
...
| `combat` — Combat | 21 |
| `compiler_cardprogram` — Compiler and CardProgram pieces | 215 |
...
| `residual.effect_clause.unparsed-clause-grammar` | `one_shot_effects` | 2,907 | 504 | 504 | `absent` | `untested` |
...
| `residual.effect_clause.deal-damage` | `one_shot_effects` | 1,048 | 140 | 140 | `absent` | `untested` |
| `residual.mechanic_dependency.cr-509-declare-blockers-step` | `keyword_mechanics` | 421 | 136 | 136 | `absent` | `untested` |
| `residual.effect_clause.return` | `one_shot_effects` | 743 | 113 | 113 | `absent` | `untested` |
| `residual.mechanic_dependency.cr-111-tokens` | `keyword_mechanics` | 311 | 106 | 106 | `absent` | `untested` |
| `residual.effect_clause.destroy-target` | `one_shot_effects` | 590 | 96 | 96 | `absent` | `untested` |
| `residual.effect_clause.exile` | `one_shot_effects` | 1,059 | 92 | 92 | `absent` | `untested` |
...
| `residual.effect_clause.destroy-mass` | `one_shot_effects` | 201 | 46 | 46 | `absent` | `untested` |
...
| `residual.effect_clause.sacrifice` | `one_shot_effects` | 387 | 39 | 39 | `absent` | `untested` |
