...
verified: "2ec35c5c5ec82eb00cdde5291744b5e3c13af127672d4c3171d75b22c5547358"
...
- Mapped pinned rules: 593 / 3,300
- Applicable piece pairs: 19,597
- Covered piece pairs: 69
...
|---|---|---:|---:|---:|---|---|
| `residual.continuous_layer.continuous-effect-layers-and-dependencies` | `continuous_effects` | 9,684 | 3,049 | 3,049 | `absent` | `untested` |
| `residual.activated_effect.unparsed-clause-grammar` | `one_shot_effects` | 2,880 | 711 | 711 | `absent` | `untested` |
| `residual.effect_clause.unparsed-clause-grammar` | `one_shot_effects` | 2,943 | 483 | 483 | `absent` | `untested` |
| `residual.mechanic_dependency.cr-611-continuous-effects` | `keyword_mechanics` | 565 | 156 | 156 | `absent` | `untested` |
...
| `residual.activated_effect.put-counter` | `one_shot_effects` | 408 | 55 | 55 | `absent` | `untested` |
| `residual.keyword_dependency.first-strike` | `keyword_mechanics` | 363 | 54 | 54 | `absent` | `untested` |
...
| `residual.keyword_dependency.cycling` | `keyword_mechanics` | 297 | 41 | 41 | `absent` | `untested` |
