...
| Deterministic tests discovered | 3960 |
| Authoritative kernel | `implemented_partial` |
| Server runtime | `implemented_single_process_restart_and_lifecycle_recovery` |
| Browser client | `implemented_current_generic_choice_forms_and_match_operations` |
