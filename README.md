...
fixed independent life instructions, static life-gain doubling, and static
redirection to a current damageable source. The damage-aftermath source is an
immutable LKI snapshot, and its nested proposal reenters ordinary replacement,
prevention, damage-result, trigger-discovery, and replay paths. A required source
choice preserves later sibling
